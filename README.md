...
A high-performance IoT ecosystem that bridges cloud intelligence with precise hardware execution. This project utilizes an **ESP8266** for multi-platform connectivity and an **Arduino Uno** to manage a motorized door assembly, security locking, and an automated irrigation system.

## 🏠 System Architecture
The system operates on a specialized **Master-Slave Serial Protocol** via UART at 9600 Baud:
1. **Master (ESP8266 12E):** Cloud Gateway managing **Sinric Pro** and **Blynk IoT**.
...
* **Bi-directional Sync:** Manual button presses on the Arduino update the cloud UI in real-time.
